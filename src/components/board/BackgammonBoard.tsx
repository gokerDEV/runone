...
const pointX = [6.24, 13.67, 21.09, 28.54, 35.96, 43.39, 56.45, 63.91, 71.33, 78.76, 86.2, 93.63];
    ...
    <div className="w-full max-w-xl mx-auto relative aspect-[488.5/581.7] select-none">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-[33.6%] h-[6.75%] flex items-center justify-center px-4 pointer-events-auto">
          <div
            className="flex w-full items-center justify-center h-full cursor-pointer hover:bg-black/5 rounded-[19px] transition"
            onClick={clickOff}
          >
            <OffTray
              color={isBlack ? "black" : "white"}
