  ...
  return (
    <>
      <div className="h-full w-full rounded-full overflow-hidden flex border shadow-sm">
        <div className="transition-all duration-500 border-r border-gray-300" style={{ width: `${hostPct}%`, backgroundColor: 'rgb(251,249,244)' }} />
        <div className="transition-all duration-500" style={{ width: `${playerPct}%`, backgroundColor: 'rgb(37,37,37)' }} />
      </div>
    </>
  );
}
